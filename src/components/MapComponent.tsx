...
const SUB_DISTRICT_COORDS: Record<string, [number, number]> = {
  ...
  'ตำบลหนองเม็ก': [17.350, 103.170],
  'ตำบลพังงู': [17.275, 103.075],
  'ตำบลสะแบง': [17.290, 103.140],
  'ตำบลสร้อยพร้าว': [17.410, 103.090],
  'ตำบลบ้านเชียง': [17.408, 103.238],
  'ตำบลบ้านยา': [17.420, 103.100],
  'ตำบลโพนงาม': [17.280, 103.010],
  'ตำบลผักตบ': [17.320, 102.990],
  'ตำบลหนองไผ่': [17.340, 103.040],
  'ตำบลหนองสระปลา': [17.430, 103.160],
  'ตำบลดอนหายโศก': [17.290, 103.110],
};
